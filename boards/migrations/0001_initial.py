# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2020-03-27 05:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident_time', models.TimeField(default=datetime.datetime(2020, 3, 27, 14, 5, 25, 351784))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='boards.Post')),
